				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						...
						if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2) {
							echo '<li class="side-item side-item-category">Catálogos</li>
									<li class="slide">
						...
						if ($_SESSION['rol'] == 1) {
							echo '<li class="side-item side-item-category">Configuraciones</li>
									<li class="slide">
										<a class="side-menu__item sub" data-bs-toggle="slide" href="#">
						...
						if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2) {
							echo '<li class="side-item side-item-category">Herramientas</li>
							<li class="slide">
							<a class="side-menu__item sub" data-bs-toggle="slide" href="#">
