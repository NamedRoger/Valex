...
var getCusotmerPrice = (customer, product) => {
  console.log(product);
  let price = customer.precio === "1" ? new Number(product.venta) : customer.precio === "2" ? new Number(product.medio) : new Number(product.mayoreo);
  return price;
};
 ...
 */
//# sourceMappingURL=chunk-4NDO4BCQ.js.map
