        ...
        function jsxDEV(type, config, maybeKey, source, self) {
          {
            ...
            if (type && type.defaultProps) {
              var defaultProps10 = type.defaultProps;
              for (propName in defaultProps10) {
                if (props[propName] === void 0) {
                  props[propName] = defaultProps10[propName];
                }
              }
            }
            if (key || ref) {
...
var removeItemLocalStorage = (key) => localStorage.removeItem(key);
var totalCurrency = (total) => new Intl.NumberFormat("es-MX", { style: "currency", currency: "MXN" }).format(total);
var getCusotmerPrice = (customer, product) => {
  let price = customer.precio === "1" ? product.venta : customer.precio === "2" ? product.medio : product.mayoreo;
  return price;
};
...
var AbstractModalHeader = /* @__PURE__ */ React11.forwardRef((_a, ref) => {
  ...
  const context3 = (0, import_react17.useContext)(ModalContext_default);
...
var Button = /* @__PURE__ */ React16.forwardRef((_ref, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Component, Object.assign({}, props, buttonProps, {
    ref
  }));
});
...
var Anchor = /* @__PURE__ */ React17.forwardRef((_ref, ref) => {
  ...
  if (isTrivialHref2(props.href) && !props.role || props.role === "button") {
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("a", Object.assign({
      ref
    }, props, buttonProps, {
      onKeyDown: handleKeyDown
    }));
...
var Button2 = /* @__PURE__ */ React18.forwardRef((_a, ref) => {
  var _b = _a, {
    as,
    bsPrefix,
    variant,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, buttonProps), props), {
    ref,
    className: (0, import_classnames8.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size2 && `${prefix}-${size2}`, props.href && props.disabled && "disabled")
  }));
});
...
function useForceUpdate() {
  var _useReducer = (0, import_react29.useReducer)(function(state) {
    return !state;
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react30.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
// node_modules/@restart/ui/esm/usePopper.js
var _excluded4 = ["enabled", "placement", "strategy", "modifiers"];
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  } = _ref, config = _objectWithoutPropertiesLoose5(_ref, _excluded4);
...
function useDropdownMenu(options = {}) {
  const context3 = (0, import_react33.useContext)(DropdownContext_default);
...
function DropdownMenu(_ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_jsx_runtime18.Fragment, {
...
var $9d939cbc98267846$var$SSRContext = /* @__PURE__ */ import_react34.default.createContext($9d939cbc98267846$var$defaultContext);
function $9d939cbc98267846$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react34.useContext)($9d939cbc98267846$var$SSRContext);
  ...
  return /* @__PURE__ */ import_react34.default.createElement($9d939cbc98267846$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $9d939cbc98267846$export$619500959fc48b26(defaultId) {
  let ctx = (0, import_react34.useContext)($9d939cbc98267846$var$SSRContext);
  if (ctx === $9d939cbc98267846$var$defaultContext && !$9d939cbc98267846$var$canUseDOM)
    console.warn("When server rendering, you must wrap your application in an <SSRProvider> to ensure consistent ids are generated between the client and server.");
  return (0, import_react34.useMemo)(() => defaultId || `react-aria${ctx.prefix}-${++ctx.current}`, [
    defaultId
  ]);
}
function $9d939cbc98267846$export$535bd6ca7f90a273() {
  ...
  let [isSSR, setIsSSR] = (0, import_react34.useState)(isInSSRContext);
...
function DropdownToggle({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_jsx_runtime20.Fragment, {
    children: children(props, meta)
  });
}
...
var _excluded6 = ["eventKey", "disabled", "onClick", "active", "as"];
...
var DropdownItem = /* @__PURE__ */ React24.forwardRef((_ref, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Component, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  const context3 = (0, import_react37.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(DropdownContext_default.Provider, {
      value: context3,
      children
    })
  });
...
var DropdownItem2 = /* @__PURE__ */ React27.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    eventKey,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Component, __spreadProps(__spreadValues(__spreadValues({}, props), dropdownItemProps), {
    ref,
...
var context = /* @__PURE__ */ React28.createContext(null);
...
var DropdownMenu2 = /* @__PURE__ */ React30.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    className,
    align,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(Component, __spreadProps(__spreadValues(__spreadProps(__spreadValues(__spreadValues({}, props), menuProps), {
    style: style2
...
var DropdownToggle2 = /* @__PURE__ */ React31.forwardRef((_a, ref) => {
  var _b = _a, {
    bsPrefix,
    split,
    className,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(Component, __spreadValues(__spreadValues({
    className: (0, import_classnames11.default)(className, prefix, split && `${prefix}-split`, !!isInputGroup && (dropdownContext == null ? void 0 : dropdownContext.show) && "show")
  }, toggleProps), props));
});
...
var Dropdown2 = /* @__PURE__ */ React32.forwardRef((pProps, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Component, __spreadProps(__spreadValues({}, props), {
        ref,
        className: (0, import_classnames12.default)(className, show && "show", (!drop || drop === "down") && prefix, drop === "up" && "dropup", drop === "end" && "dropend", drop === "start" && "dropstart")
      }))
    })
  });
});
 ...
 */
//# sourceMappingURL=chunk-BI4ZWMCM.js.map
